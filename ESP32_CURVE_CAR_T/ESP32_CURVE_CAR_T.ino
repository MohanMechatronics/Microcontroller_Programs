...
void sendData() {
  ...
  // Check for combined button presses first
  if (currentForwardState && currentLeftState) {
    Serial.println("Button Pressed: Forward + Left");
    data = 5;
  } else if (currentBackwardState && currentLeftState) {
    Serial.println("Button Pressed: Backward + Left");
    data = 6;
  } else if (currentForwardState && currentRightState) {
    Serial.println("Button Pressed: Forward + Right");
    data = 7;
  } else if (currentBackwardState && currentRightState) {
    Serial.println("Button Pressed: Backward + Right");
    data = 8;
  } 
  // Check for single button presses
  else if (currentForwardState) {
    Serial.println("Button Pressed: Forward");
    data = 1;
  } else if (currentBackwardState) {
    Serial.println("Button Pressed: Backward");
    data = 2;
  } else if (currentLeftState) {
  ...
  // Reset command if no button is pressed
  else {
