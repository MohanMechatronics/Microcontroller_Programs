...
void setup()
{
  ...
  for (int i = 0; i < totalNotes; i++)
  {
    ...
    if (currentNote != 0)
    {
      ledcSetup(ledcChannel, 4000, 8); // LEDC channel, frequency, resolution
      ledcAttachPin(buzzerPin, ledcChannel);
      ledcWriteTone(ledcChannel, currentNote);
    }
    else
    {
...
void loop()
{
  ...
  // You can click reset on the ESP32 to replay the song.
}