...
.slider2.round:before {
  border-radius: 50%;
    ...
    <div align=center> 
    <button class="btn btn2 triangle-left" id="turnleft" ontouchstart='onTouchStartAndEnd("9")'
            ontouchend='onTouchStartAndEnd("0")'></button>
    <button class="btn btn5 stop" id="stop"></button>
    <button class="btn btn1 triangle-right" id="turnright" ontouchstart='onTouchStartAndEnd("10")'
            ontouchend='onTouchStartAndEnd("0")'></button>
    </div>
    <br/>
