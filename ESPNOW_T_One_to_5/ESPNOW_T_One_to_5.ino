...
int mac2[6] = {0x08, 0xD1, 0xF9, 0x29, 0xC1, 0xFD}; // 08:D1:F9:29:C1:FD done YELLOW
//int mac3[6] = {0xD4, 0x8A, 0xFC, 0x9E, 0x83, 0xE1}; // D4:8A:FC:9E:83:E1 done ORANGE
...
/* .all{
 ...
 .all::before {
    ...
    <div  class="slaves" align=center>
        <label class="switch" >
            <input type="checkbox" id="NODE1" onchange="send_State_Cmd('ESP32Slave1','NODE1')">
            <span class="slider2 round "></span>
          </label>

          <label class="switch">
            <input type="checkbox" id="NODE2" onchange="send_State_Cmd('ESP32Slave2','NODE2')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE3" onchange="send_State_Cmd('ESP32Slave3','NODE3')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE4" onchange="send_State_Cmd('ESP32Slave4','NODE4')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE5" onchange="send_State_Cmd('ESP32Slave5','NODE5')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE6" onchange="send_State_Cmd('ESP32Slave6','NODE6')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE7" onchange="send_State_Cmd('ESP32Slave7','NODE7')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE8" onchange="send_State_Cmd('ESP32Slave8','NODE8')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE9" onchange="send_State_Cmd('ESP32Slave9','NODE9')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch">
            <input type="checkbox" id="NODE10" onchange="send_State_Cmd('ESP32Slave10','NODE10')">
            <span class="slider2 round "></span>
          </label>
          <label class="switch" for="NODE11">
            
            <input type="checkbox" id="NODE11" onchange="send_State_Cmd('ESP32Slave11','NODE11')">
            <span class="slider2 round "></span>
          </label>
    </div>
</br>
