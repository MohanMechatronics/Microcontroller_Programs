...
const char* mdnsName = "facecamera"; 
...
uint8_t broadcastAddress[] = {0xC4, 0xDE, 0xE2, 0x12, 0x3F, 0xA8};
        ...
        if (is_enrolling == 1){
            ...
            if (matched_id >= 0) {
                ...
                if (matched_id<name_length)
                  ...
                  rgb_printf(image_matrix, FACE_COLOR_GREEN, "[%u] hlo bro", matched_id);
